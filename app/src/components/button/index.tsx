...
export const Button: FC<ButtonProps> = ({ children, loading = false, disabled, classes, ...props }) => {
  ...
  const classNames =
    "inline-flex items-center px-6 py-2 border text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-blue-500 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 h-10";
  return (
    <button
